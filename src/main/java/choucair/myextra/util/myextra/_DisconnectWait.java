...
public interface _DisconnectWait extends Com4jObject {
  // Methods:
  /**
   */
   ...
   * </p>
   * @return The COM property Connected as a boolean
   */
  @DISPID(8)
  @PropGet
   ...
   * </p>
   * @param newValue The new value for the COM property Connected as a boolean
   */
  @DISPID(8)
  @PropPut
